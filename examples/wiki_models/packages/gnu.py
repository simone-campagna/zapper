...
xmodel = Product('xmodel', 'application')
...
for version in '4.1.2', '4.5.2', '4.7.0':
    ...
    xmodel_3_3_1 = Package(xmodel, '3.3.1', suite=gnu)
    xmodel_3_3_1.var_set("XMODEL_HOME", "/opt/gnu-{}/xmodel-3.3.1".format(version))
    xmodel_3_3_1.requires('zlib', VERSION >= '2.3')
